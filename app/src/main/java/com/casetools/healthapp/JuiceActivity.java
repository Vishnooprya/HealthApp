...
public class JuiceActivity extends AppCompatActivity {
    int[] images=new int[]{R.drawable.apple,R.drawable.banana,R.drawable.lemon,R.drawable.mango,R.drawable.orange,R.drawable.papaya};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        final List<String> quotes = databaseAccess.getnamejuice();
        final String[] names=toStringArray(quotes);
        //databaseAccess.close();

        //ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, quotes);
        // this.listView.setAdapter(adapter);
        final List<String> vals=databaseAccess.getvaluejuice();
        ...
        SimpleAdapter s= new SimpleAdapter(getBaseContext(),mylist,R.layout.juice_list,from,to);
        ...
        l.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(JuiceActivity.this, vals.get(position) + "", Toast.LENGTH_SHORT).show();
                showbox(s);
